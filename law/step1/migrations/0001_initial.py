# Generated by Django 5.0.2 on 2024-06-21 21:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendees', models.ManyToManyField(to='step1.myclubuser')),
                ('Venue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='step1.venue')),
            ],
        ),
    ]
